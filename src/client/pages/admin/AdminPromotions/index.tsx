    ...
    <div style={{ padding: '1.5rem' }}>
      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: '1.5rem' }}>
        <button style={tabStyle('coupons')} onClick={() => setTab('coupons')}>
          <FiTag size={13} style={{ marginRight: 6 }} />
          Coupons ({coupons.length})
        </button>
        <button style={tabStyle('promotions')} onClick={() => setTab('promotions')}>
          <FiZap size={13} style={{ marginRight: 6 }} />
          ...
          >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setCouponForm((p) => ({ ...p, type: e.target.value as ICoupon['type'] }))
                }
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setCouponForm((p) => ({ ...p, minOrderAmount: Number(e.target.value) }))
                }
              />
            </div>
            <div>
              ...
              <input
                ...
                value={
                  couponForm.expiresAt
                    ? new Date(couponForm.expiresAt).toISOString().slice(0, 16)
                    : ''
                }
                onChange={(e) =>
                  setCouponForm((p) => ({
            ...
            <div style={{ gridColumn: '1 / -1', display: 'flex', gap: 8 }}>
              ...
              <button type="button" className="btn" onClick={() => setShowCouponForm(false)}>
                Cancel
              </button>
            </div>
          </form>
          ...
          >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setPromoForm((p) => ({ ...p, type: e.target.value as IPromotion['type'] }))
                }
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setPromoForm((p) => ({
                    ...p,
                    discountType: e.target.value as IPromotion['discountType'],
                  }))
                }
              >
                <option value="percentage">Percentage</option>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setPromoForm((p) => ({ ...p, discountValue: Number(e.target.value) }))
                }
              />
            </div>
            <div>
              ...
              <input
                ...
                value={
                  promoForm.startDate
                    ? new Date(promoForm.startDate).toISOString().slice(0, 16)
                    : ''
                }
                onChange={(e) =>
                  setPromoForm((p) => ({
            ...
            <div>
              ...
              <input
                ...
                required
                value={
                  promoForm.endDate ? new Date(promoForm.endDate).toISOString().slice(0, 16) : ''
                }
                onChange={(e) =>
                  setPromoForm((p) => ({
                    ...p,
            ...
            <div style={{ gridColumn: '1 / -1', display: 'flex', gap: 8 }}>
              ...
              <button type="button" className="btn" onClick={() => setShowPromoForm(false)}>
                Cancel
              </button>
            </div>
          </form>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ borderBottom: '2px solid var(--color-neutral-100)' }}>
                {['Code', 'Type', 'Value', 'Min Order', 'Uses', 'Expires', 'Status', ''].map(
                  (h) => (
                    <th key={h} style={{ ...tdStyle, fontWeight: 700 }}>
                      {h}
                    </th>
                  ),
                )}
            ...
            <tbody>
              {coupons.length === 0 && (
                <tr>
                  <td
                    colSpan={8}
                    style={{ ...tdStyle, textAlign: 'center', color: 'var(--color-neutral-400)' }}
                  >
                    No coupons yet.
                  </td>
                </tr>
