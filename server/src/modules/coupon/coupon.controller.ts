...
export const listCoupons = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    sendSuccess(res, { items, total, page, limit, totalPages: Math.ceil(total / limit) }, 'Coupons fetched')
  } catch (err) { next(err) }
}
...
export const listPromotions = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    sendSuccess(res, { items, total, page, limit, totalPages: Math.ceil(total / limit) }, 'Promotions fetched')
  } catch (err) { next(err) }
}
...
export const togglePromotion = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
export const getActivePromotions = async (_req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    const now = new Date()
